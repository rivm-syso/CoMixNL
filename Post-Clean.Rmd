...
participant_common <- read_csv(
  file = "CoMix_nl_participant_common.csv",
  col_types = cols(
...
participant_extra <- read_csv(
  file = "CoMix_nl_participant_extra.csv",
  col_types = cols(
    .default = col_character(),
...
contact_common <- read_csv(
  file = "CoMix_nl_contact_common.csv",
  col_types = cols(
    .default = col_character(),
    part_id = col_integer(),
...
contact_extra <- read_csv(
  file = "CoMix_nl_contact_extra.csv",
  col_types = cols(
    .default = col_character(),
    survey_round = col_integer(),
    date = col_date("%Y-%m-%d"),
...
participant_data <- participant_data %>%
  mutate(
    part_elevated_risk = coalesce(tolower(part_elevated_risk), part_high_risk),
    part_elevated_risk = if_else(grepl("answer", part_elevated_risk), "no answer", part_elevated_risk)
  )
```
